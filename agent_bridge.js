(function() {
    ...
    console.log("[Agent Bridge] Initializing Tool Call Engine v4.3.29 (Cross-Platform Edition)...");
...
请确认收到，并等待用户指令。`;
    ...
    function executeCommand(command, controller, opts) {
        ...
        try { diagAttach({ phase: 'dispatch', v: '4.3.29', cmd: normCmd.slice(0, 300) }); } catch (_) {}
